...
getwd()
#^ this directory contains all the below files
# Edit these to match your data file names: 
#AvsB (HFH vs HFNH)--> No GO terms
#AvsC (HFH vs LFH)
#BvsD (HFNH vs LFNH)
#CvsD (LFH vs LFNH)
input="BvsD_GO.csv" # two columns of comma-separated values: gene id, continuous measure of significance. To perform standard GO enrichment analysis based on Fisher's exact test, use binary measure (0 or 1, i.e., either sgnificant or not).

goAnnotations="Sym_ID2GO.tab2" # two-column, tab-delimited, one line per gene, multiple GO terms separated by semicolon. If you have multiple lines per gene, use nrify_GOtable.pl prior to running this script.
goDatabase="go.obo" # download from http://www.geneontology.org/GO.downloads.ontology.shtml
goDivision="BP" #  ran MF,  BP, and CC
...
# do not continue if tls -lhe printout shows that no GO terms pass 10% FDR.
